...
# %% auto 0
__all__ = ['foo', 'name_cleanup', 'dict_to_digraph', 'rand_connection_matrix', 'connection_matrix_to_dict',
           'connection_dict_to_matrix', 'SparseLinearCustom', 'VNNHelper', 'mk_NodeGroups', 'structured_layer_info',
           'expand_edge_dict', 'Linear_block', 'Conv1D_x2_Max_block', 'reverse_edge_dict', 'reverse_node_props',
           'Linear_block_reps', 'VisableNeuralNetwork']
